...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # Your Code here
        tf.keras.layers.Conv2D(128, (3, 3), padding='same', activation='relu', input_shape=(300, 300, 3)),
    ...
    model.compile(optimizer="adam", loss="binary_crossentropy", metrics=['acc'])    #Your Code Here#)

    model.fit(train_generator, validation_data=validation_generator, epochs=30, verbose=1)  #Your Code Here#)
